...
export const API = {
  LOOKUP: {
    ...
    PRODUCT_BY_ID: (id: string | number) =>
      `${API_BASE_URL}/lookup/products/${id}`,
    TRANSPORTERS: `${API_BASE_URL}/lookup/transporters`,
    TRANSPORTER_BY_ID: (id: string | number) =>
      `${API_BASE_URL}/lookup/transporters/${id}`,
    PLANT_CODES: `${API_BASE_URL}/lookup/plant-codes`,
    PLANT_CODE_BY_ID: (id: string | number) =>
      `${API_BASE_URL}/lookup/plant-codes/${id}`,
    SALES_ZONES: `${API_BASE_URL}/lookup/sales-zones`,
    SALES_ZONE_BY_ID: (id: string | number) =>
      `${API_BASE_URL}/lookup/sales-zones/${id}`,
    PACK_CONFIGS: `${API_BASE_URL}/lookup/pack-configs`,
    PACK_CONFIG_BY_ID: (id: string | number) =>
      `${API_BASE_URL}/lookup/pack-configs/${id}`,
    CUSTOMERS: `${API_BASE_URL}/lookup/customers`,
    CUSTOMER_BY_ID: (id: string | number) =>
      `${API_BASE_URL}/lookup/customers/${id}`,
    PRINTERS: `${API_BASE_URL}/lookup/printers`,
    PRINTER_BY_ID: (id: string | number) =>
      `${API_BASE_URL}/lookup/printers/${id}`,
    MATERIAL_BARCODES: `${API_BASE_URL}/lookup/material-barcodes`,
    MATERIAL_BARCODE_BY_ID: (id: string | number) =>
      `${API_BASE_URL}/lookup/material-barcodes/${id}`,
  ...
  ADMIN: {
    ...
    SALES_ORDER_BY_ID: (id: string | number) =>
      `${API_BASE_URL}/admin/sales-orders/${id}`,
    ERP_MATERIALS_BY_ORDER: (orderId: number) =>
      `${API_BASE_URL}/admin/orders/${orderId}/erp-materials`,
    INCREMENT_ISSUE_STAGE: (orderId: number) =>
      `${API_BASE_URL}/admin/orders/${orderId}/erp-materials/increment-issue-stage`,
    UPDATE_ISSUE_STAGE: (orderId: number) =>
      `${API_BASE_URL}/admin/orders/${orderId}/erp-materials/update-issue-stage`,
    INCREMENT_PACKING_STAGE: (orderId: number) =>
      `${API_BASE_URL}/admin/orders/${orderId}/erp-materials/increment-packing-stage`,
    UPDATE_PACKING_STAGE: (orderId: number) =>
      `${API_BASE_URL}/admin/orders/${orderId}/erp-materials/update-packing-stage`,

    UPDATE_MAPPING: (orderId: number) =>
      `${API_BASE_URL}/admin/orders/${orderId}/erp-materials/update-mapping`,
    ...
    REPORT_ANALYSIS: (params?: {
      ...
      if (params?.salesZoneId)
        query.set("salesZoneId", String(params.salesZoneId));
    ...
    SKIP_ISSUE_STAGE: (orderId: number, materialId: number) =>
      `${API_BASE_URL}/admin/orders/${orderId}/erp-materials/${materialId}/skip-issue`,
    RESET_ERP_DATA: (id: string | number) =>
      `${API_BASE_URL}/sales-orders/${id}/reset`,
    ...
    ARCHIVED_ORDERS: (params?: {
      ...
      if (params?.limit) query.set("limit", String(params.limit));
      if (params?.search) query.set("search", params.search);
      if (params?.paymentFilter)
        query.set("paymentFilter", params.paymentFilter);
  ...
  SALES: {
    ...
    VERIFY_SO: (soNumber: string) =>
      `${API_BASE_URL}/sales-crud/verify-so/${soNumber}`,
    ...
    ATTACHMENTS_BY_ORDER: (id: string | number) =>
      `${API_BASE_URL}/sales-crud/${id}/attachments`,
    ATTACHMENT_DOWNLOAD: (id: number) =>
      `${API_BASE_URL}/sales-crud/attachments/download/${id}`,
    SALES_FG_STORAGE_REPORT: (params?: {
      search?: string;
      page?: number;
      limit?: number;
      ageFilter?: string;
      ...
      if (params?.ageFilter) query.set("ageFilter", params.ageFilter);
      const qs = query.toString();
      return `${API_BASE_URL}/reports/sales-order/sales-fg-storage-report${qs ? "?" + qs : ""}`;
    },
  },
  AUTH: {
  ...
  USER_DASHBOARD: {
    ...
    MOBILE_DOWNLOAD_DETAILS_BY_ID: (id: number) =>
      `${API_BASE_URL}/user-dashboard/orders/${id}/download-details`,
    // Endpoint for downloading order details by SO number
    MOBILE_DOWNLOAD_DETAILS_BY_SO: (soNumber: string) =>
      `${API_BASE_URL}/user-dashboard/orders/son/${soNumber}/download-details`,
    // Endpoint for syncing order by SO number (Combined both attachments and data)
    MOBILE_SYNC_ORDER_BY_SO: (soNumber: string) =>
      `${API_BASE_URL}/user-dashboard/orders/son/${soNumber}/sync`,
    // Endpoint for uploading data by SO number
    MOBILE_UPLOAD_DATA_BY_SO: (soNumber: string) =>
      `${API_BASE_URL}/user-dashboard/orders/son/${soNumber}/data`,
    // Endpoint for uploading attachments by SO number
    MOBILE_UPLOAD_ATTACHMENTS_BY_SO: (soNumber: string) =>
      `${API_BASE_URL}/user-dashboard/orders/son/${soNumber}/attachments`,
    // Get Order Details by ID
    GET_ORDER_DETAILS: (id: number) =>
      `${API_BASE_URL}/user-dashboard/orders/${id}`,
  ...
  SO_ARCHIVE: {
    ARCHIVE: (soNumber: string) =>
      `${API_BASE_URL}/so-archive/${soNumber}/archive`,
    DELETE: (soNumber: string) =>
      `${API_BASE_URL}/so-archive/${soNumber}/delete`,
    DOWNLOAD_ATTACHMENT: (fileId: number) =>
      `${API_BASE_URL}/so-archive/attachments/${fileId}/download`,
  ...
  DISPATCH: {
    ...
    SEARCH_SO: (soNumber: string) =>
      `${API_BASE_URL}/dispatch/search-so/${encodeURIComponent(soNumber)}`,
    LIST_ATTACHMENTS: (id: number) =>
      `${API_BASE_URL}/dispatch/${id}/attachments`,
    ...
    ATTACHMENT: (id: number, fileName: string) =>
      `${API_BASE_URL}/dispatch/${id}/attachments/${encodeURIComponent(fileName)}`,
    MOBILE: {
      ...
      ADD_ATTACHMENTS: (id: number) =>
        `${API_BASE_URL}/dispatch/mobile/${id}/attachments`,
  ...
  VEHICLE_ENTRY: {
    ...
    GET_ATTACHMENTS: (id: string | number) =>
      `${API_BASE_URL}/dispatch/vehicle-entries/${id}/attachments`,
    DOWNLOAD_ATTACHMENT: (id: string | number, fileName: string) =>
      `${API_BASE_URL}/dispatch/vehicle-entries/${id}/attachments/${encodeURIComponent(fileName)}`,
    MOBILE: {
      CREATE: `${API_BASE_URL}/vehicle-entry`,
      UPLOAD_ATTACHMENTS: (id: string | number) =>
        `${API_BASE_URL}/vehicle-entry/${id}/attachments`,
      GET_ATTACHMENTS: (id: string | number) =>
        `${API_BASE_URL}/vehicle-entry/${id}/attachments`,
      DOWNLOAD_ATTACHMENT: (id: string | number, fileName: string) =>
        `${API_BASE_URL}/vehicle-entry/${id}/attachments/${encodeURIComponent(fileName)}`,
    },
  },
  ERP_MATERIAL_FILES: {
    ...
    BY_SO: (so: string) =>
      `${API_BASE_URL}/v1/erp-material-files/by-sale-order/${encodeURIComponent(so)}`,

    //Download file stream
    DOWNLOAD: (id: number) =>
      `${API_BASE_URL}/v1/erp-material-files/${id}/download`,
  ...
  DASHBOARD: {
    ...
    OPERATOR_STATS: (date?: string) =>
      `${API_BASE_URL}/dashboard/operator-stats${date ? `?date=${date}` : ""}`,
    ADMIN_ERP_IMPORT_COUNTS: (date?: string) =>
      `${API_BASE_URL}/dashboard/admin-erp-import-counts${date ? `?date=${date}` : ""}`,
    ADMIN_BIN_COUNTS: (date?: string) =>
      `${API_BASE_URL}/dashboard/admin-bin-counts${date ? `?date=${date}` : ""}`,
    ADMIN_BACKLOG_COUNT: (date?: string) =>
      `${API_BASE_URL}/dashboard/admin-backlog-count${date ? `?date=${date}` : ""}`,
  },
  SO_CHAT: {
    MENTION_USERS: (orderId: number) =>
      `${API_BASE_URL}/so-chat/${orderId}/mention-users`,
    MESSAGES: (orderId: number) =>
      `${API_BASE_URL}/so-chat/${orderId}/messages`,
  ...
  SO_NOTIFICATIONS: {
    ...
    CLEAR_SO: (orderId: number) =>
      `${API_BASE_URL}/so-notifications/clear-so/${orderId}`,
  },
