...
const passwordChecks = [
  ...
  { label: "At least 2 special characters (!@#$%^&*)", check: (pw: string) => (pw.match(/[!@#$%^&*]/g) || []).length >= 2 },
  { label: "At least 2 numbers", check: (pw: string) => (pw.match(/\d/g) || []).length >= 2 },
  { label: "At least 1 uppercase letter", check: (pw: string) => /[A-Z]/.test(pw) },
];
