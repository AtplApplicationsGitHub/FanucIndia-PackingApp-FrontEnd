  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogPortal>
        ...
        <DialogContent
          className="
  fixed top-1/2 left-1/2 w-full max-w-lg 
  -translate-x-1/2 -translate-y-1/2 
  rounded-2xl bg-white dark:bg-zinc-900 text-black dark:text-white 
  p-4 shadow-lg border border-zinc-200 dark:border-zinc-700"
