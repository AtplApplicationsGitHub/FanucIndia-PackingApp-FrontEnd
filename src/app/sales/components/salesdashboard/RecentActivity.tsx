...
type AnyActivity = any; // adapt to your actual activity type if available
    ...
    <Box className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
      ...
      <Box className="mt-4 divide-y divide-gray-100">
        {(!activities || activities.length === 0) ? (
          ...
          activities.map((activity: AnyActivity, index: number) => {
            ...
            return (
              <motion.div
                key={`${activity.salesOrderNumber}-${activity.activityTimestamp || index}`}
