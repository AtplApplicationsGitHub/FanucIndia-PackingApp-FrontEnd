      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md overflow-hidden border border-gray-100 dark:border-gray-700">
        ...
        <div className="p-6 flex flex-col items-center gap-6">
          ...
          <div className="w-full flex flex-col items-center gap-3 py-4">
            <div className="w-14 h-14 rounded-full grid place-items-center bg-yellow-50 dark:bg-yellow-900/10">
              <svg
                ...
                className="w-7 h-7 text-yellow-600 dark:text-yellow-300"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
            ...
            <div className="text-4xl sm:text-5xl font-extrabold text-yellow-600 dark:text-yellow-300">
          ...
          <div className="w-full flex flex-col items-center gap-3 py-4">
            ...
            <div className="text-4xl sm:text-5xl font-extrabold text-green-600 dark:text-green-300">
